...
(3,2)
\end{verbatim}
Тобто \(D_{x_0}^{\delta^{*}}(u_3) = 1,\ D_{x_1}^{\delta^*}(u_1) = 1,\ D_{x_2}^{\delta^*}(u_2) = 1,\ D_{x_3}^{\delta^*}(u_2) = 1 \).

Отже, за оптимальною стратегією, в стані системи \(x_0 = (a, a)\) слід обирати дії \(u_3 = (2, 2)\), в стані \(x_1 = (a, b)\) дії \(u_1 = (1, 2)\), в станах \(x_2 = (b, a)\) та \(x_3 = (b, b)\) дії \(u_2 = (2, 1)\). Дії \(u_0 = (1, 1)\) не слід обирати взагалі. \end{example}
